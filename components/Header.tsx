        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col space-y-4" dir="rtl">
              {/* <Link
                href="/"
                className="text-gray-700 hover:text-cyan-400  font-medium"
              >
                الرئيسية
              </Link> */}
              {/* <Link
              ...
              <Link
                href="/dashboard"
                className="bg-cyan-400 text-white px-4 py-2 rounded-full hover:bg-blue-600 transition-colors inline-block text-center"
              >
                لوحة التحكم
              </Link> */}
            </nav>
