...
export default function CTASection() {
  return (
    <section className="relative py-20 bg-gradient-to-r from-cyan-700 to-pink-700 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div dir="rtl">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-400"> التعليم لطفلك؟</span>
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            انضم إلى الآلاف من العائلات التي تثق بـ kidyland لتوفير تعليم ممتع و عالي الجودة لأطفالهم. ابدأ بتجربة مجانية اليوم!
          </p>
        </div>
