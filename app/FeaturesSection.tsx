  ...
  const features = [
    {
      ...
      description: 'حول التعليم المكبر  إلى مغامره مثيرة مع الإنجازات والشارات والتحديات التفاعلية التي تحفز الأطفال.',
    ...
    {
      icon: 'ri-parent-line',
      title: ' متابعه الوالدين',
      description: 'تتبع تقدم طفلك، واطلع على الإنجازات، واحصل على رؤى حول رحلة التعلم.',
      color: 'from-pink-500 to-rose-500'
    },
    {
      icon: 'ri-graduation-cap-line',
      title: 'مناهج عالميه للتعليم المبكر',
      description: 'مناهج مصممه هع معلمين ذوي الخبرة المتخصصين في التعليم المبكر للاطفال  للأطفال.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16" >
          <h2 className="text-4xl font-bold text-indigo-900 mb-4">
            لماذا تختار  kidyland
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            صممنا كل جانب من جوانب التطبيق لجعل التعليم ممتع و جذاب وسهل الوصول  .
          </p>
        </div>
